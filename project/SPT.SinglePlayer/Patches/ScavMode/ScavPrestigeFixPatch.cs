...
public class ScavPrestigeFixPatch : ModulePatch
{
    ...
    {
        return AccessTools.Constructor(typeof(GClass3692), new Type[] { typeof(Profile), typeof(InventoryController), typeof(GClass3868), typeof(ISession) }, false);
    }

    [PatchPrefix]
    public static void PatchPrefix(GClass3692 __instance, ref Profile profile)
    {
