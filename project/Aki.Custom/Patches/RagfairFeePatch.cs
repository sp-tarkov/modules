...
namespace Aki.Custom.Patches
{
    ...
    public class RagfairFeePatch : ModulePatch
    {
		...
		[PatchPrefix]
        private static void PatchPrefix(ref Item ___item_0, ref GClass3087 ___gclass3085_0, ref double ___double_0, ref bool ___bool_0)
        {
            RequestHandler.PutJson("/client/ragfair/offerfees", new
            {
                ...
                fee = Mathf.CeilToInt((float)GClass2103.CalculateTaxPrice(___item_0, ___gclass3085_0.OfferItemCount, ___double_0, ___bool_0))
            }.ToJson());
        }
    }
}