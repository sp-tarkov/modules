...
namespace SPT.Debugging.Commands
{
    public class DebugCommands
    {
        [ConsoleCommand(
            ...
            "",
            null,
            "keys: Survived, Killed, Runner, MissingInAction, Transit",
            new string[] { }
        )]
        public static void DebugExtract(ExitStatus status)
        {
            ...
            string exitName = Singleton<GameWorld>
                .Instance.ExfiltrationController.ExfiltrationPoints.FirstOrDefault()
                .name;
